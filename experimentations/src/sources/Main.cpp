...
int main(int argc, char *argv[]){ 
    ...
    Test4CycleCounting::testCount4CycleLowMedHighVV(10);
    Test4CycleCounting::testCount4CycleVertexLocalLowMedHighVV(10);
    Test4CycleCounting::testCount4CycleEdgeLocalLowMedHighVV(10);
